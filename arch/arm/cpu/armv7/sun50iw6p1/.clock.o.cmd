cmd_arch/arm/cpu/armv7/sun50iw6p1/clock.o := /opt/h6/h6_1.4.2/lichee/brandy/u-boot-2014.07/../gcc-linaro/bin/arm-linux-gnueabi-gcc -Wp,-MD,arch/arm/cpu/armv7/sun50iw6p1/.clock.o.d  -nostdinc -isystem /opt/h6/h6_1.4.2/lichee/brandy/gcc-linaro/bin/../lib/gcc/arm-linux-gnueabi/4.6.3/include -Iinclude  -I/opt/h6/h6_1.4.2/lichee/brandy/u-boot-2014.07/arch/arm/include -I/opt/h6/h6_1.4.2/lichee/brandy/u-boot-2014.07/include/openssl -D__KERNEL__ -DCONFIG_SYS_TEXT_BASE=0x4A000000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -g -fstack-usage -Wno-format-nonliteral -march=armv7-a -Werror -mno-unaligned-access -DCONFIG_ARM -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(clock)"  -D"KBUILD_MODNAME=KBUILD_STR(clock)" -c -o arch/arm/cpu/armv7/sun50iw6p1/clock.o arch/arm/cpu/armv7/sun50iw6p1/clock.c

source_arch/arm/cpu/armv7/sun50iw6p1/clock.o := arch/arm/cpu/armv7/sun50iw6p1/clock.c

deps_arch/arm/cpu/armv7/sun50iw6p1/clock.o := \
  include/common.h \
...
arch/arm/cpu/armv7/sun50iw6p1/clock.o: $(deps_arch/arm/cpu/armv7/sun50iw6p1/clock.o)
